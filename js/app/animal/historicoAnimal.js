...
app.controller('historicoAnimalCtrl', ['$scope', '$http', '$filter', '$modal', 'MyService', 'filterFilter', 'datepickerConfig',function($scope, $http, $filter,$modal, MyService,filterFilter, datepickerConfig) {
    $scope.getGrafico =function(){
      ...
      $http.get('http://192.168.1.100/1337/ordeno/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
...
$scope.getPesos = function () {
      $scope.pesos=null;
      $http.get('http://192.168.1.100/1337/peso/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
    ...
    $scope.getTratamientos = function () {
      ...
      $http.get('http://192.168.1.100/1337/tratamiento/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
    ...
    $scope.getBanos = function () {
      $scope.banos=null;
      $http.get('http://192.168.1.100/1337/sumbano/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
    ...
    $scope.getMedicamentos = function () {
      ...
      $http.get('http://192.168.1.100/1337/summedicamento/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
    ...
    $scope.getMedicamentos();
     $scope.getAlimentos = function () {
      ...
      $http.get('http://192.168.1.100/1337/sumalimento/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
    ...
    $scope.getSaltos = function () {
      $scope.saltos=null;
      $http.get('http://192.168.1.100/1337/salto/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
