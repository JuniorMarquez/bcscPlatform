...
app.controller('historicoArticuloCtrl', ['$scope', '$http', '$filter', '$modal', 'MyService', 'filterFilter', 'datepickerConfig',function($scope, $http, $filter,$modal, MyService,filterFilter, datepickerConfig) {
    $scope.getGrafico =function(){
      ...
      $http.get('http://192.168.1.100:1337/ordeno/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
...
$scope.getPesos = function () {
      $scope.pesos=null;
      $http.get('http://192.168.1.100:1337/peso/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getEntradas = function () {
      ...
      $http.get('http://192.168.1.100:1337/tratamiento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getDepartamentos = function () {
      ...
      $http.get('http://192.168.1.100:1337/sumdepartamento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getMedicamentos = function () {
      ...
      $http.get('http://192.168.1.100:1337/summedicamento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getMedicamentos();
     $scope.getAlimentos = function () {
      ...
      $http.get('http://192.168.1.100:1337/sumalimento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getSaltos = function () {
      $scope.saltos=null;
      $http.get('http://192.168.1.100:1337/salto/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getPromedio =function(){
      ...
      $http.get('http://192.168.1.100:1337/ordeno').then(function (resp) {
