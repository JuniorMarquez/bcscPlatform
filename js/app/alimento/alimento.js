...
$http.get('http://192.168.1.100/1337/alimento/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
  ...
  $scope.deleteAlimento = function(animal){
    $http.delete('http://192.168.1.100/1337/alimento/'+alimento.id , alimento)
  ...
  $scope.doneEditingAlimento = function(item){
    ...
    if (MyService.data.idenAlimento){
      $scope.pop4();
      $http.put('http://192.168.1.100/1337/alimento/'+MyService.data.idenAlimento , alimentoAct)
    }
    else {
      $scope.pop3();;
      $http.post('http://192.168.1.100/1337/alimento/', alimentoAct)
    }
    $scope.items = null;
